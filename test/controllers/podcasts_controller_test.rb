...
class PodcastsControllerTest < ActionController::TestCase
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post :create, podcast: { author: @podcast.author, body: @podcast.body, image: @podcast.image, keywords: @podcast.keywords, path: @podcast.path, title: @podcast.title }
    end
  ...
  test "should update podcast" do
    patch :update, id: @podcast, podcast: { author: @podcast.author, body: @podcast.body, image: @podcast.image, keywords: @podcast.keywords, path: @podcast.path, title: @podcast.title }
    assert_redirected_to podcast_path(assigns(:podcast))
  end
